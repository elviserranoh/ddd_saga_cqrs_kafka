...
public class OrderDataMapper {
    ...
    public TrackOrderResponse orderToTrackOrderToResponse(Order order) {
    ...
    private List<OrderItem> orderItemsToOrderItemsEntities(@NotNull List<com.food.ordering.system.order.service.domain.dto.create.OrderItem> items) {
